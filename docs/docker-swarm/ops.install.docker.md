...
ExecStart=/usr/bin/dockerd -H tcp://0.0.0.0:12375 -H unix://var/run/docker.sock  $DOCKER_NETWORK_OPTIONS
...
# demote docker node 
docker node demote dockerID
```



***docker daemon configuartion args***
